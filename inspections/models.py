...
class Inspection(models.Model):
    ...
    inspection_area = models.CharField(max_length=100) # for special dropdowns

    def __unicode__(self):
        return self.restaurant + ", " + self.inspection_date + ", " + self.inspection_score
...
class Violations(models.Model):
    ...
    def __unicode__(self):
        return self.inspection + ", " + self.violation_name + ", " + self.violation_num
